            ...
            <v-row>
              ...
              <v-col cols="12" sm="12">
                <v-card class="co pa-2">
                  ...
                  <v-chip class="ma-2" label color="white"> Drinks </v-chip>
                  <v-chip class="ma-2" label color="white"> Pasta </v-chip>
                  <v-chip class="ma-2" label color="white"> Pizza </v-chip>
                  <v-chip class="ma-2" label color="white"> Sandwiches </v-chip>
                </v-card>
              </v-col>
            </v-row>
          </v-col>
            ...
            <v-row>
              ...
              <v-col cols="12" sm="12">
                <v-card class="co pa-2">
                  ...
                  <div class="text-center">
                    ...
                    <h5 class="text-grey mt-3">Ogodiseng</h5>
              ...
              <v-col cols="12" sm="12">
                <v-card class="co pa-2">
                  ...
                  <p class="text-grey mt-2 text-caption">May 31, 2024</p>
                </v-card>
              </v-col>
            </v-row>
          </v-col>
...
export default {
  data: () => ({
    ...
    dishes: [
      { image: "f1.png", name: "Plat unique", money: "R180.00" },
      { image: "f2.png", name: "Plat africains", money: "R155.00" },
      { image: "f3.png", name: "Smoked stake", money: "R150.00" },
      { image: "f4.png", name: "Rajthan", money: "R179.00" },
      { image: "f5.png", name: "The messy house", money: "R156.00" },
      { image: "f6.png", name: "Cinamon dusked tart", money: "R135.00" },
      { image: "f7.avif", name: "HomeMade choc", money: "R99.00" },
      { image: "44.png", name: "Lagsan", money: "R123.00" },
    ],
  }),
};
</script>
